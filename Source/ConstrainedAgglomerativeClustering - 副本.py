...
class ConstrainedClustering:
    def __init__(self, distance_matrix, adjacency_matrix):
    ...
    def save_results(self, filepath="../Output/constrained_clustering_results.npz"):
        np.savez(filepath, cluster_labels=self.labels_history)

    def save_merge_info(self, filepath="../Output/merge_info.npy"):
        np.save(filepath, self.merge_info)
...
clustering = ConstrainedClustering(distance_matrix, adjacency_matrix)
clustering.fit()
clustering.save_results()
clustering.save_merge_info()
